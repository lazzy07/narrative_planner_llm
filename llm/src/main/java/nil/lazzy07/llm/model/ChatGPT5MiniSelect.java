/*
* File name: ChatGPT5MiniSelect.java
* Project: 
* Author: Lasantha M Senanayake
* Date created: 2026-02-25 03:07:43
// Date modified: 2026-02-25 03:08:12
* ------
*/
...
public class ChatGPT5MiniSelect extends LLMApi {
  ...
  public ChatGPT5MiniSelect(boolean useCache, String cacheDirectory, String domain) {
  ...
  public ChatGPT5MiniSelect(boolean useCache,
  ...
  protected String callModel(String systemPrompt,
    ...
    body.put("text", Map.of(
        "format", Map.of(
            ...
            "name", "action_select",
            "strict", true,
            "schema", buildActionSelectSchemaObjectWrapped())));
   ...
   * {
   * "items": [
   * { "actionId": number, "reason": string }
   * ]
   * }
   */
  private Map<String, Object> buildActionSelectSchemaObjectWrapped() {
  ...
  private String unwrapItemsArrayAsString(String raw) {
    try {
      ...
      if (items == null || !items.isArray()) {
        throw new RuntimeException("Expected object with 'items' array. Got: " + raw);
      }

      return MAPPER.writeValueAsString(items);

    } catch (Exception e) {
      throw new RuntimeException("Failed to unwrap items array: " + raw, e);
    }
  }
}
